...
var Post = function Post(_ref2, _ref3) {
  var _post$owner, _post$owner2, _post$owner2$strategi, _post$owner2$strategi2, _user, _post$owner3, _post$owner3$strategi, _post$owner3$strategi2, _user2, _post$owner4, _post$owner4$strategi, _post$owner4$strategi2, _user3, _user4, _user4$strategies, _user4$strategies$use, _user5;
  var id = _ref2.id,
  ...
  return (0, _jsxRuntime.jsxs)(_ServerSideProps.ServerSideProps, _objectSpread(_objectSpread({
    ...
    canDelete: _permissions.admins.includes((_user4 = user) === null || _user4 === void 0 ? void 0 : (_user4$strategies = _user4.strategies) === null || _user4$strategies === void 0 ? void 0 : (_user4$strategies$use = _user4$strategies[(_user5 = user) === null || _user5 === void 0 ? void 0 : _user5.strategy]) === null || _user4$strategies$use === void 0 ? void 0 : _user4$strategies$use.email),
    children: [(0, _jsxRuntime.jsx)(_Votings.Votings, {
      policies: [_Votings.VotingPolicies.SingleVote]
...
var Forum = function Forum(_ref5, _ref6) {
  ...
  var _deletePost = function deletePost(id) {
    var _owner$strategies, _owner$strategies$use, _user6, _user7, _user7$strategies, _user7$strategies$use, _user8, _user9, _user9$strategies, _user9$strategies$use, _user10;
    var deleted = posts.find(function (post) {
      return post.id === id;
    });
    var _ref8 = deleted || {},
      owner = _ref8.owner;
    if ((owner === null || owner === void 0 ? void 0 : (_owner$strategies = owner.strategies) === null || _owner$strategies === void 0 ? void 0 : (_owner$strategies$use = _owner$strategies[(_user6 = user) === null || _user6 === void 0 ? void 0 : _user6.strategy]) === null || _owner$strategies$use === void 0 ? void 0 : _owner$strategies$use.email) !== ((_user7 = user) === null || _user7 === void 0 ? void 0 : (_user7$strategies = _user7.strategies) === null || _user7$strategies === void 0 ? void 0 : (_user7$strategies$use = _user7$strategies[(_user8 = user) === null || _user8 === void 0 ? void 0 : _user8.strategy]) === null || _user7$strategies$use === void 0 ? void 0 : _user7$strategies$use.email) && !_permissions.admins.includes((_user9 = user) === null || _user9 === void 0 ? void 0 : (_user9$strategies = _user9.strategies) === null || _user9$strategies === void 0 ? void 0 : (_user9$strategies$use = _user9$strategies[(_user10 = user) === null || _user10 === void 0 ? void 0 : _user10.strategy]) === null || _user9$strategies$use === void 0 ? void 0 : _user9$strategies$use.email)) {
